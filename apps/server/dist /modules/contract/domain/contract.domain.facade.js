...
exports.ContractDomainFacade = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const database_1 = require("../../../core/database");
const contract_model_1 = require("./contract.model");
let ContractDomainFacade = class ContractDomainFacade {
    ...
    async findManyByTenant(item, queryOptions = {}) {
        if (!item) {
        ...
        const queryOptionsEnsured = {
            includes: queryOptions.includes,
            orders: queryOptions.orders,
            filters: Object.assign(Object.assign({}, queryOptions.filters), { tenantId: item.id }),
        };
        const query = this.databaseHelper.applyQueryOptions(this.repository, queryOptionsEnsured);
        return query.getMany();
    }
    async findManyByLandlord(item, queryOptions = {}) {
        if (!item) {
        ...
        const queryOptionsEnsured = {
            includes: queryOptions.includes,
            orders: queryOptions.orders,
            filters: Object.assign(Object.assign({}, queryOptions.filters), { landlordId: item.id }),
        };
        const query = this.databaseHelper.applyQueryOptions(this.repository, queryOptionsEnsured);
        return query.getMany();
    }
};
exports.ContractDomainFacade = ContractDomainFacade;
exports.ContractDomainFacade = ContractDomainFacade = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(contract_model_1.Contract)),
    __metadata("design:paramtypes", [typeorm_2.Repository,
        database_1.DatabaseHelper])
], ContractDomainFacade);
//# sourceMappingURL=contract.domain.facade.js.map