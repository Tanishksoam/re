...
exports.ImageDomainFacade = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const database_1 = require("../../../core/database");
const image_model_1 = require("./image.model");
let ImageDomainFacade = class ImageDomainFacade {
...
exports.ImageDomainFacade = ImageDomainFacade;
exports.ImageDomainFacade = ImageDomainFacade = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(image_model_1.Image)),
    __metadata("design:paramtypes", [typeorm_2.Repository,
        database_1.DatabaseHelper])
], ImageDomainFacade);
//# sourceMappingURL=image.domain.facade.js.map