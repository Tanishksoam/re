...
exports.FeedbackByPropertyController = void 0;
...
let FeedbackByPropertyController = class FeedbackByPropertyController {
    constructor(propertyDomainFacade, feedbackDomainFacade, eventService, authenticationDomainFacade) {
    ...
    async findManyPropertyId(propertyId, request) {
        ...
        const items = await this.feedbackDomainFacade.findManyByProperty(parent, queryOptions);
        return items;
    }
...
exports.FeedbackByPropertyController = FeedbackByPropertyController;
__decorate([
    (0, common_1.Get)('/property/:propertyId/feedbacks'),
    __param(0, (0, common_1.Param)('propertyId')),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], FeedbackByPropertyController.prototype, "findManyPropertyId", null);
__decorate([
    (0, common_1.Post)('/property/:propertyId/feedbacks'),
    __param(0, (0, common_1.Param)('propertyId')),
    ...
    __metadata("design:returntype", Promise)
], FeedbackByPropertyController.prototype, "createByPropertyId", null);
exports.FeedbackByPropertyController = FeedbackByPropertyController = __decorate([
...
//# sourceMappingURL=feedbackByProperty.controller.js.map