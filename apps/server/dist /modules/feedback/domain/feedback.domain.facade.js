...
exports.FeedbackDomainFacade = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const database_1 = require("../../../core/database");
const feedback_model_1 = require("./feedback.model");
let FeedbackDomainFacade = class FeedbackDomainFacade {
    ...
    async findManyByUser(item, queryOptions = {}) {
        ...
        const queryOptionsEnsured = {
            includes: queryOptions.includes,
            orders: queryOptions.orders,
            filters: Object.assign(Object.assign({}, queryOptions.filters), { userId: item.id }),
        };
        const query = this.databaseHelper.applyQueryOptions(this.repository, queryOptionsEnsured);
        return query.getMany();
    }
};
exports.FeedbackDomainFacade = FeedbackDomainFacade;
exports.FeedbackDomainFacade = FeedbackDomainFacade = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(feedback_model_1.Feedback)),
    __metadata("design:paramtypes", [typeorm_2.Repository,
        database_1.DatabaseHelper])
], FeedbackDomainFacade);
//# sourceMappingURL=feedback.domain.facade.js.map