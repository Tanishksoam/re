...
const database_configuration_service_1 = require("../configuration/database.configuration.service");
let DatabaseMigrationService = class DatabaseMigrationService {
    ...
    getDataSource() {
        ...
        const dataSource = new typeorm_1.DataSource(Object.assign({}, options));
        return dataSource;
    }
};
...
exports.DatabaseMigrationService = DatabaseMigrationService = __decorate([
    ...
    __metadata("design:paramtypes", [database_configuration_service_1.DatabaseConfigurationService])
